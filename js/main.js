window.addEventListener("DOMContentLoaded", function () {
  ...
  sec02.to("#section02 .star03", { x: 1000, y: 0 }, 0);
  sec02.to("#section02 .keyboard", { x: 2400, y: 0 }, 0);
...
// section 06 chapter image moving animation
...
// section 06 square height 0 animation
...
// section 06 title moving animation
...
// section 06 headset moving animation
...
// section 06 title text scale animation
gsap.to("#title_svg", {
  scale: 60,
  y: 2400,
  // x: -200,
...
// section 07 video control animation
...
// section 07 video shrink animation
...
gsap.to("#section07 .side", {
  scrollTrigger: {
    ...
    // onEnterBack: () => {
    //   // 스크롤이 트리거 요소의 시작 위치에 역방향으로 도달했을 때
    //   $("#section07 .side").addClass("on");
    // },
    // onLeave: () => {
...
section10pages.forEach((section) => {
  sec10_total += section.clientWidth; // 각각의 page 가로 크기 합산
});

// console.log(sec10_total); // 12764
